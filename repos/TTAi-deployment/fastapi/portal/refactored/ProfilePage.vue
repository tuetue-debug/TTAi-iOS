...
<template>
  <section class="single-column-grid profile-shell-page">
    <div class="page-intro">
      ...
      <p>Manage your portal profile and contact information.</p>
    </div>
    ...
    <div v-else class="single-column-grid">
      ...
      <article class="panel-subtle">
        <h4 style="margin-top: 0; margin-bottom: 12px;">Social accounts</h4>
        <p style="margin-bottom: 16px; color: #64748b; font-size: 14px;">Link your Google, GitHub, or Apple account for future OAuth login.</p>

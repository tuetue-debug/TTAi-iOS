    ...
    <section class="dashboard-main-shell">
      <header class="dashboard-topbar">
        ...
        <div class="dashboard-actions">
          ...
          <button class="ghost-btn top-action-btn" @click="router.push('/dashboard/docs')">Docs</button>
          <button class="ghost-btn top-action-btn" @click="handleLogout">Log out</button>
        </div>
      </header>

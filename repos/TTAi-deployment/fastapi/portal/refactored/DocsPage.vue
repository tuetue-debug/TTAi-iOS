    ...
    <article class="panel-card integrations-shell docs-shell-page">
      <div class="integrations-header">
        <div>
          ...
          <h3>TTAi developer documentation</h3>
        ...
        <template v-if="activeTab === 'overview'">
          <div class="integrations-resource-grid docs-overview-grid">
            <article class="panel-subtle">
              <div class="preview-label">Workspace resources</div>
              <div class="resource-list">
                <div class="resource-item">
                  ...
                  <a class="ghost-btn link-btn" href="https://console.tuetue.vn" target="_blank" rel="noreferrer">Open</a>
                </div>
                <div class="resource-item">
                  <div>
                ...
                <div class="resource-item">
                  ...
                  <div class="inline-row">
                    ...
                    <a class="ghost-btn link-btn" href="https://console.tuetue.vn/openapi.json" target="_blank" rel="noreferrer">Open</a>
                  </div>
                </div>
                <div class="resource-item">
                  <div>
            ...
            <article class="panel-subtle">
              <div class="preview-label">Quick start</div>
              <div class="endpoint-list compact-list">
                <div class="endpoint-item">
                  <div class="endpoint-method">1</div>
                  <div class="endpoint-path">Create an API key</div>
                  <div class="endpoint-desc">Use the API Keys section in the console to issue credentials.</div>
                </div>
                <div class="endpoint-item">
                  <div class="endpoint-method">2</div>
                  <div class="endpoint-path">Use the runtime base URL</div>
                  <div class="endpoint-desc">Send requests to <code>https://api.tuetue.vn</code>.</div>
                </div>
                <div class="endpoint-item">
                  <div class="endpoint-method">3</div>
                  <div class="endpoint-path">Test in Reference</div>
                  <div class="endpoint-desc">Switch to the Reference tab to inspect schemas and run test calls.</div>
                </div>
              </div>
            </article>
          </div>
          ...
          <div class="integrations-panel-head" style="margin-top: 12px;">
            <div>
              <h4>Key endpoints</h4>
              <p>Most-used paths for portal and runtime integrations.</p>
            </div>
          </div>
